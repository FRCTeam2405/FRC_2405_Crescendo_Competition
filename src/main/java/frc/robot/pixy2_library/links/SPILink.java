package frc.robot.pixy2_library.links;

import edu.wpi.first.wpilibj.SPI;
import frc.robot.pixy2_library.Pixy2.Checksum;
...
public class SPILink implements Link {
	...
	public int open(int arg) {
		...
		//TODO! is this even the right mode?
		spi.setMode(SPI.Mode.kMode2);
		//TODO! How do we set endian-ness? (order of information)
		// spi.setMSBFirst();
