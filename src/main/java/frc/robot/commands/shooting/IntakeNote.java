...
public class IntakeNote extends Command {
  ...
  public IntakeNote(Intake sysIntake, Feeder sysFeeder, Dashboard sysDashboard) {
  ...
  public IntakeNote(Intake sysIntake, Feeder sysFeeder, Dashboard sysDashboard, DoubleSupplier speedIntakeRight, DoubleSupplier speedFeederTop, DoubleSupplier speedFeederBottom) {
